                ...
                <div class="card flex-fill" >
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><a href="edit_course_content.php?course_content_id=<?php echo $content['course_content_id'] ?>"><i class="fas fa-edit">Course Content</i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
